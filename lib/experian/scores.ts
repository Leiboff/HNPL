 ...
 *
 * Adapted from docs/experian/scores.ts — the verified reference, which stays
 * unmodified. This file is byte-identical to it apart from this note: the band
 * tables and the warning-code semantics were validated against the live
 * service and there is nothing here to improve.
 *
