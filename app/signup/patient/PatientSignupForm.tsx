...
const INPUT_CLS = 'w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-[#0F4C75] focus:outline-none focus:ring-1 focus:ring-[#0F4C75]';
...
export default function PatientSignupForm({ invitation, token }: Props) {
  ...
  return (
    <>
      {invitation && (
        <div className="mb-6 rounded-xl border border-[#0F4C75]/20 bg-[#0F4C75]/5 px-4 py-4">
      ...
      <p className="mt-6 text-center text-sm text-gray-500">
        ...
        <Link href="/login" className="font-medium" style={{ color: '#0F4C75' }}>
          Sign in →
        </Link>
      </p>
    </>
