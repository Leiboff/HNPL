  ...
  return (
    <div className="find-care-bar-wrap group" data-testid="find-care-bar-wrap">
      <Link
        ...
        className="find-care-bar-surface block rounded-2xl bg-white shadow-sm hover:shadow-md transition-shadow px-4 py-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#15A89E]/60 focus-visible:ring-offset-2"
      >
