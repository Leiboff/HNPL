...
//
// The pivotal commit point in initiateCheckout calls Paystack's
// /transaction/initialize while it holds a fresh payments row + a
// stamped peach_payment_id. If a slow Paystack roundtrip stalls the
...
//   - issue a second Paystack /transaction/initialize when the first
//     authorization_url is still in flight to the browser.
//
...
// genuine retries (a Paystack decline takes longer than that to come
...
/**
 * Has a recent Pay attempt already stamped its Paystack reference?
 *
